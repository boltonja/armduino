...
#if !defined(__CR2_MACHINE__DEFAULT_TYPES_H__)
#  define __CR2_MACHINE__DEFAULT_TYPES_H__
#  if defined(__REDLIB__)
#    include_next <machine/_default_types.h>
#  else
#    include <newlib_inc/machine/_default_types.h>
