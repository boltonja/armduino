...
#if !defined(__CR2_C___4_6_2_PROFILE_IMPL_PROFILER_STATE_H__)
#  define __CR2_C___4_6_2_PROFILE_IMPL_PROFILER_STATE_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/profile/impl/profiler_state.h>
#  else
#    include <newlib_inc/c++/4.6.2/profile/impl/profiler_state.h>
