...
#if !defined(__CR2_C___4_6_2_TR1_EXP_INTEGRAL_TCC__)
#  define __CR2_C___4_6_2_TR1_EXP_INTEGRAL_TCC__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/tr1/exp_integral.tcc>
#  else
#    include <newlib_inc/c++/4.6.2/tr1/exp_integral.tcc>
