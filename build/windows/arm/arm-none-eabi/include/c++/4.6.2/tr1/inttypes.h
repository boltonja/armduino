...
#if !defined(__CR2_C___4_6_2_TR1_INTTYPES_H__)
#  define __CR2_C___4_6_2_TR1_INTTYPES_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/tr1/inttypes.h>
#  else
#    include <newlib_inc/c++/4.6.2/tr1/inttypes.h>
