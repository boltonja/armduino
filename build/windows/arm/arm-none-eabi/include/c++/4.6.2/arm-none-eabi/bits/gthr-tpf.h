...
#if !defined(__CR2_C___4_6_2_ARM_NONE_EABI_BITS_GTHR_TPF_H__)
#  define __CR2_C___4_6_2_ARM_NONE_EABI_BITS_GTHR_TPF_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/arm-none-eabi/bits/gthr-tpf.h>
#  else
#    include <newlib_inc/c++/4.6.2/arm-none-eabi/bits/gthr-tpf.h>
