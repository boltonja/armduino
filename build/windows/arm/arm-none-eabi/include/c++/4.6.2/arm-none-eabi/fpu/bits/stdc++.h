...
#if !defined(__CR2_C___4_6_2_ARM_NONE_EABI_FPU_BITS_STDC___H__)
#  define __CR2_C___4_6_2_ARM_NONE_EABI_FPU_BITS_STDC___H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/arm-none-eabi/fpu/bits/stdc++.h>
#  else
#    include <newlib_inc/c++/4.6.2/arm-none-eabi/fpu/bits/stdc++.h>
