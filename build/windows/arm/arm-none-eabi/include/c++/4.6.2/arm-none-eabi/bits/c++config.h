...
#if !defined(__CR2_C___4_6_2_ARM_NONE_EABI_BITS_C__CONFIG_H__)
#  define __CR2_C___4_6_2_ARM_NONE_EABI_BITS_C__CONFIG_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/arm-none-eabi/bits/c++config.h>
#  else
#    include <newlib_inc/c++/4.6.2/arm-none-eabi/bits/c++config.h>
