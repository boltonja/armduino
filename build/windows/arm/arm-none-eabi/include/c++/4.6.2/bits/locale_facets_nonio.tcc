...
#if !defined(__CR2_C___4_6_2_BITS_LOCALE_FACETS_NONIO_TCC__)
#  define __CR2_C___4_6_2_BITS_LOCALE_FACETS_NONIO_TCC__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/locale_facets_nonio.tcc>
#  else
#    include <newlib_inc/c++/4.6.2/bits/locale_facets_nonio.tcc>
