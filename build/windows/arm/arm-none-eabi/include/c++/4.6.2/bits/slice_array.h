...
#if !defined(__CR2_C___4_6_2_BITS_SLICE_ARRAY_H__)
#  define __CR2_C___4_6_2_BITS_SLICE_ARRAY_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/slice_array.h>
#  else
#    include <newlib_inc/c++/4.6.2/bits/slice_array.h>
