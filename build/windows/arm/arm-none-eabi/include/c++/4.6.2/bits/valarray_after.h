...
#if !defined(__CR2_C___4_6_2_BITS_VALARRAY_AFTER_H__)
#  define __CR2_C___4_6_2_BITS_VALARRAY_AFTER_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/valarray_after.h>
#  else
#    include <newlib_inc/c++/4.6.2/bits/valarray_after.h>
