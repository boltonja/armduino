...
#if !defined(__CR2_C___4_6_2_BITS_FSTREAM_TCC__)
#  define __CR2_C___4_6_2_BITS_FSTREAM_TCC__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/fstream.tcc>
#  else
#    include <newlib_inc/c++/4.6.2/bits/fstream.tcc>
