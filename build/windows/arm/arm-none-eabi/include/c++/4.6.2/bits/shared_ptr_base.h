...
#if !defined(__CR2_C___4_6_2_BITS_SHARED_PTR_BASE_H__)
#  define __CR2_C___4_6_2_BITS_SHARED_PTR_BASE_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/shared_ptr_base.h>
#  else
#    include <newlib_inc/c++/4.6.2/bits/shared_ptr_base.h>
