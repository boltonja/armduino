...
#if !defined(__CR2_C___4_6_2_BITS_REGEX_CURSOR_H__)
#  define __CR2_C___4_6_2_BITS_REGEX_CURSOR_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/regex_cursor.h>
#  else
#    include <newlib_inc/c++/4.6.2/bits/regex_cursor.h>
