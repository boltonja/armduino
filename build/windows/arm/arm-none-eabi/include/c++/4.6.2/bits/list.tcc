...
#if !defined(__CR2_C___4_6_2_BITS_LIST_TCC__)
#  define __CR2_C___4_6_2_BITS_LIST_TCC__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/list.tcc>
#  else
#    include <newlib_inc/c++/4.6.2/bits/list.tcc>
