...
#if !defined(__CR2_C___4_6_2_BITS_STL_QUEUE_H__)
#  define __CR2_C___4_6_2_BITS_STL_QUEUE_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/bits/stl_queue.h>
#  else
#    include <newlib_inc/c++/4.6.2/bits/stl_queue.h>
