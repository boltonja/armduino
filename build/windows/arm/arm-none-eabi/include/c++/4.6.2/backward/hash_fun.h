...
#if !defined(__CR2_C___4_6_2_BACKWARD_HASH_FUN_H__)
#  define __CR2_C___4_6_2_BACKWARD_HASH_FUN_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/backward/hash_fun.h>
#  else
#    include <newlib_inc/c++/4.6.2/backward/hash_fun.h>
