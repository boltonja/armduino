...
#if !defined(__CR2_C___4_6_2_EXT_STDIO_FILEBUF_H__)
#  define __CR2_C___4_6_2_EXT_STDIO_FILEBUF_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/stdio_filebuf.h>
#  else
#    include <newlib_inc/c++/4.6.2/ext/stdio_filebuf.h>
