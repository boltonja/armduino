...
#if !defined(__CR2_C___4_6_2_EXT_PB_DS_PRIORITY_QUEUE_HPP__)
#  define __CR2_C___4_6_2_EXT_PB_DS_PRIORITY_QUEUE_HPP__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/pb_ds/priority_queue.hpp>
#  else
#    include <newlib_inc/c++/4.6.2/ext/pb_ds/priority_queue.hpp>
