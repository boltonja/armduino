...
#if !defined(__CR2_C___4_6_2_EXT_PB_DS_TRIE_POLICY_HPP__)
#  define __CR2_C___4_6_2_EXT_PB_DS_TRIE_POLICY_HPP__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/pb_ds/trie_policy.hpp>
#  else
#    include <newlib_inc/c++/4.6.2/ext/pb_ds/trie_policy.hpp>
