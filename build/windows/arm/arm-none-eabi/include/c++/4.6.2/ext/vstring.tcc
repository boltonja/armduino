...
#if !defined(__CR2_C___4_6_2_EXT_VSTRING_TCC__)
#  define __CR2_C___4_6_2_EXT_VSTRING_TCC__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/vstring.tcc>
#  else
#    include <newlib_inc/c++/4.6.2/ext/vstring.tcc>
