...
#if !defined(__CR2_C___4_6_2_EXT_POD_CHAR_TRAITS_H__)
#  define __CR2_C___4_6_2_EXT_POD_CHAR_TRAITS_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/pod_char_traits.h>
#  else
#    include <newlib_inc/c++/4.6.2/ext/pod_char_traits.h>
