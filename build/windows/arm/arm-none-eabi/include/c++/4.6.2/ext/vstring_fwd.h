...
#if !defined(__CR2_C___4_6_2_EXT_VSTRING_FWD_H__)
#  define __CR2_C___4_6_2_EXT_VSTRING_FWD_H__
#  if defined(__REDLIB__)
#    include_next <c++/4.6.2/ext/vstring_fwd.h>
#  else
#    include <newlib_inc/c++/4.6.2/ext/vstring_fwd.h>
